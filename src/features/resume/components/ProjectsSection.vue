      ...
      <article v-for="project in content.projects" :key="project.name" class="project-card">
        ...
        <div class="project-footer">
          ...
          <div v-if="project.name === 'Aylon'" class="project-downloads" aria-label="Aylon downloads">
            <a href="" class="platform-button" aria-label="Download Aylon for Windows">
            ...
            <a href="" class="platform-button" aria-label="Download Aylon for macOS">
              <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="" class="platform-button" aria-label="Download Aylon for Linux">
